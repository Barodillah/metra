...
const MacBookPortal = () => {
    ...
    return (
        <div className="relative w-full max-w-[500px] mx-auto py-10 md:py-20">
            {/* MacBook Frame */}
            <div
                className="relative bg-slate-800 rounded-2xl border-4 border-slate-700 shadow-[0_50px_100px_-20px_rgba(0,0,0,0.5),0_30px_60px_-30px_rgba(99,102,241,0.3)] overflow-hidden"
            ...
            >
                ...
                <div className="absolute inset-0 bg-[#0F172A] p-6 flex flex-col pt-10">
                    ...
                    {/* FASE 1: INPUT */}
                    <div className={`transition-all duration-1000 absolute inset-0 p-4 sm:p-8 pt-8 sm:pt-10 flex flex-col justify-center gap-2 sm:gap-4 ${phase === 1 ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10 pointer-events-none'}`}>
                        <div className="space-y-2 sm:space-y-4">
                            <div className="h-8 sm:h-10 bg-slate-900 border border-white/10 rounded-lg flex items-center px-3 sm:px-4 text-xs sm:text-sm text-white font-bold">
                                {typedName}<span className="w-1 h-3 sm:h-4 bg-teal-500 ml-1 animate-pulse"></span>
                            </div>
                            <div className="h-8 sm:h-10 bg-slate-900 border border-white/10 rounded-lg flex items-center px-3 sm:px-4 text-[10px] sm:text-xs text-slate-500">
                                14 Jan 1995
                            </div>
                            <div className="h-8 sm:h-10 bg-slate-900 border border-white/10 rounded-lg flex items-center px-3 sm:px-4 text-[10px] sm:text-xs text-slate-500">
                                09:30 AM
                            </div>
                            <div className={`mt-3 sm:mt-6 h-10 sm:h-12 rounded-xl flex items-center justify-center text-[10px] sm:text-xs font-black uppercase tracking-widest text-white transition-all duration-500 ${typedName.length === fullName.length ? 'bg-gradient-to-r from-[#6366F1] to-[#06B6D4] shadow-lg shadow-indigo-500/20' : 'bg-slate-800'}`}>
                                Reveal My Path
                            </div>
                        </div>
                    </div>
                    ...
                    <div className={`transition-all duration-1000 absolute inset-0 p-6 flex flex-col gap-4 ${phase === 3 ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-10 pointer-events-none'}`}>
                        ...
                        <div className="mt-auto bg-indigo-500/10 border border-indigo-500/20 p-3 rounded-xl">
...
const LandingPage = () => {
    ...
    return (
        <div className="min-h-screen bg-[#0F172A] text-slate-300 font-sans selection:bg-[#6366F1]/30 overflow-x-hidden">
            ...
            {/* Systems Showcase */}
            <section id="fitur" className="py-24 px-6 bg-slate-900/50 border-y border-white/5 relative z-10">
                            ...
                            <div className="flex-1 overflow-y-auto p-8 scrollbar-thin scrollbar-thumb-slate-800">
                                ...
                                {showPaywall && (
                                    <div className="flex justify-center my-8">
                                        <div className="bg-[#0F172A]/80 border border-[#6366F1]/30 p-8 rounded-3xl max-w-md text-center shadow-2xl backdrop-blur-xl animate-fade-in">
