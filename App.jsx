...
const MacBookPortal = () => {
  ...
  return (
    <div className="relative w-full max-w-[500px] mx-auto perspective-[1500px] py-10 md:py-20">
      {/* MacBook Frame */}
      <div 
        className="relative bg-slate-800 rounded-2xl border-4 border-slate-700 shadow-[0_50px_100px_-20px_rgba(0,0,0,0.5),0_30px_60px_-30px_rgba(99,102,241,0.3)] transform rotateX(15deg) rotateY(-20deg) rotateZ(5deg) transition-all duration-1000 overflow-hidden"
      ...
      >
        ...
        {/* Screen Content */}
        <div className="absolute inset-0 bg-[#0F172A] p-6 flex flex-col pt-10">
          
          {/* FASE 1: INPUT */}
          <div className={`transition-all duration-1000 absolute inset-0 p-8 flex flex-col justify-center gap-4 ${phase === 1 ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10 pointer-events-none'}`}>
             <div className="space-y-4">
               <div className="h-10 bg-slate-900 border border-white/10 rounded-lg flex items-center px-4 text-sm text-white font-bold">
                 {typedName}<span className="w-1 h-4 bg-teal-500 ml-1 animate-pulse"></span>
               </div>
               <div className="h-10 bg-slate-900 border border-white/10 rounded-lg flex items-center px-4 text-xs text-slate-500">
                 14 Jan 1995
               </div>
               <div className="h-10 bg-slate-900 border border-white/10 rounded-lg flex items-center px-4 text-xs text-slate-500">
                 09:30 AM
               </div>
               <div className={`mt-6 h-12 rounded-xl flex items-center justify-center text-xs font-black uppercase tracking-widest text-white transition-all duration-500 ${typedName.length === fullName.length ? 'bg-gradient-to-r from-[#6366F1] to-[#06B6D4] shadow-lg shadow-indigo-500/20' : 'bg-slate-800'}`}>
                 Reveal My Path
               </div>
             </div>
          </div>
          ...
          {/* FASE 2: PROCESSING */}
          <div className={`transition-all duration-1000 absolute inset-0 flex flex-col items-center justify-center ${phase === 2 ? 'opacity-100 scale-100' : 'opacity-0 scale-90 pointer-events-none'}`}>
             <div className="relative w-full h-full flex items-center justify-center">
                {/* Converging Particles */}
                <div className="absolute top-1/4 left-1/4 w-8 h-8 text-amber-500 animate-bounce transition-all">
                   <Sun size={24} />
                </div>
                <div className="absolute top-1/4 right-1/4 w-8 h-8 text-rose-500 animate-pulse delay-75">
                   <Moon size={24} />
                </div>
                <div className="absolute bottom-1/4 left-1/2 -translate-x-1/2 w-8 h-8 text-indigo-400 animate-spin transition-all">
                   <Star size={24} />
                </div>
                
                {/* Center AI Chip */}
                <div className="w-20 h-20 bg-gradient-to-tr from-[#6366F1] to-[#06B6D4] rounded-2xl flex items-center justify-center animate-pulse relative z-10">
                   <Cpu className="text-white" size={32} />
                   <div className="absolute inset-0 bg-white blur-xl opacity-20 animate-ping"></div>
                </div>

                <p className="absolute bottom-10 text-[10px] font-bold text-slate-500 tracking-[0.2em] uppercase">
                   Synthesizing Ancient Wisdom...
                </p>
             </div>
          </div>

          {/* FASE 3: OUTPUT & INSIGHT */}
          <div className={`transition-all duration-1000 absolute inset-0 p-6 flex flex-col gap-4 ${phase === 3 ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-10 pointer-events-none'}`}>
             <div className="grid grid-cols-2 gap-2">
                <div className="bg-slate-900/50 p-3 rounded-xl border border-white/10 animate-in slide-in-from-left-4 duration-500">
                   <p className="text-[8px] text-slate-500 uppercase font-bold">Weton</p>
                   <p className="text-[10px] text-white font-bold">Sabtu Pahing</p>
                </div>
                <div className="bg-slate-900/50 p-3 rounded-xl border border-white/10 animate-in slide-in-from-right-4 duration-500">
                   <p className="text-[8px] text-slate-500 uppercase font-bold">Life Path</p>
                   <p className="text-[10px] text-white font-bold">9</p>
                </div>
             </div>
             <div className="mt-auto bg-indigo-500/10 border border-indigo-500/20 p-3 rounded-xl animate-in fade-in zoom-in duration-700">
                <div className="flex gap-2 items-start">
                   <Sparkles className="text-indigo-400 shrink-0" size={14} />
                   <div className="space-y-1">
                      <p className="text-[10px] text-white font-bold">Metra AI Advisor</p>
                      <p className="text-[9px] text-slate-400 leading-relaxed">
                        Hi Arya! Your chart shows resilience. A major opportunity is coming next week...
                      </p>
                   </div>
                </div>
             </div>
      ...
      {/* Reflection Shadow */}
      <div className="absolute -bottom-10 left-1/2 -translate-x-1/2 w-[80%] h-12 bg-[#6366F1]/20 blur-3xl rounded-full"></div>
    </div>
  );
};
...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#0F172A] text-slate-300 font-sans selection:bg-[#6366F1]/30 overflow-x-hidden">
      ...
      <section className="relative pt-32 pb-24 px-6 overflow-hidden">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left z-10">
            <div className="inline-flex items-center gap-2 bg-white/5 border border-white/10 px-5 py-2 rounded-full text-[#06B6D4] text-[10px] font-black tracking-widest uppercase shadow-sm mb-10 animate-fade-in">
              <Heart size={14} className="text-rose-500 fill-rose-500" /> Positive Intuition & AI Data
            </div>
            <h1 className="text-5xl md:text-7xl xl:text-8xl font-black text-white mb-8 tracking-tighter leading-[0.9]">
              Temukan <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#6366F1] to-[#06B6D4]">Cahaya</span> <br />
              Langkah Hidupmu.
            </h1>
            <p className="text-lg text-slate-400 max-w-xl mx-auto lg:mx-0 leading-relaxed font-medium mb-12">
            ...
            <div className="max-w-xl mx-auto lg:mx-0">
              <div className="bg-[#1E293B]/40 border border-white/10 p-4 rounded-3xl shadow-2xl backdrop-blur-2xl">
                <form onSubmit={handleCalculate} className="flex flex-col sm:flex-row items-center gap-3">
                  <div className="flex-1 w-full px-5 py-3 flex items-center gap-3 bg-slate-900/50 rounded-2xl border border-white/5 focus-within:border-[#6366F1]/50 transition-all group">
                    <User className="text-slate-500 group-focus-within:text-[#6366F1]" size={18} />
                    <input 
                      type="text" 
                      placeholder="Nama Lengkap"
                      required
                      className="bg-transparent border-none outline-none w-full text-white placeholder:text-slate-600 font-bold text-sm"
                      value={formData.name}
                      onChange={(e) => setFormData({...formData, name: e.target.value})}
                    />
                  </div>
                  <div className="flex-1 w-full px-5 py-3 flex items-center gap-3 bg-slate-900/50 rounded-2xl border border-white/5 focus-within:border-[#6366F1]/50 transition-all group">
                    <Calendar className="text-slate-500 group-focus-within:text-[#6366F1]" size={18} />
                    <input 
                      type="date" 
                      required
                      className="bg-transparent border-none outline-none w-full text-white font-bold text-sm [color-scheme:dark]"
                      value={formData.dob}
                  ...
                  <button 
                    type="submit"
                    className="w-full sm:w-auto bg-gradient-to-r from-[#6366F1] to-[#06B6D4] hover:brightness-110 text-white font-black px-6 py-4 rounded-xl flex items-center justify-center gap-2 transition-all active:scale-95 shadow-xl shadow-[#6366F1]/20 uppercase tracking-widest text-[10px]"
                  >
          ...
          {/* The Metra Portal Animation */}
          <div className="z-10 relative">
             <MacBookPortal />
             {/* Decorative labels */}
             <div className="absolute top-1/4 -right-10 hidden xl:flex flex-col items-center bg-[#1E293B]/80 backdrop-blur-lg border border-white/10 p-3 rounded-2xl animate-bounce">
                <p className="text-[10px] font-black text-[#06B6D4] uppercase mb-1">AI Logic</p>
                <TrendingUp size={16} className="text-white" />
             </div>
             <div className="absolute bottom-1/4 -left-10 hidden xl:flex flex-col items-center bg-[#1E293B]/80 backdrop-blur-lg border border-white/10 p-3 rounded-2xl animate-pulse">
                <p className="text-[10px] font-black text-amber-500 uppercase mb-1">Spirit</p>
      ...
      {/* Systems Showcase */}
      <section className="py-24 px-6 bg-slate-900/50 border-y border-white/5 relative z-10">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
            <div className="text-center md:text-left group">
              <TraditionIcon type="jawa" />
              <h3 className="text-xl font-bold text-white mb-3 group-hover:text-amber-500 transition-colors tracking-tight">Primbon Jawa</h3>
            ...
            <div className="text-center md:text-left group">
              ...
              <h3 className="text-xl font-bold text-white mb-3 group-hover:text-rose-500 transition-colors tracking-tight">Metafisika Cina</h3>
            ...
            <div className="text-center md:text-left group">
              ...
              <h3 className="text-xl font-bold text-white mb-3 group-hover:text-indigo-400 transition-colors tracking-tight">Jyotish India</h3>
            ...
            <div className="text-center md:text-left group">
              ...
              <h3 className="text-xl font-bold text-white mb-3 group-hover:text-cyan-400 transition-colors tracking-tight">Universal Path</h3>
      ...
      {/* Results Section */}
      {results && (
        <section ref={resultRef} className="py-24 px-6 max-w-7xl mx-auto scroll-mt-24 relative z-10">
          <div className="text-center mb-16">
            ...
            <h2 className="text-5xl font-black text-white mb-4 tracking-tighter leading-none">Peta Cahaya {formData.name}</h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 items-start">
            ...
            <div className="space-y-8">
              <div className="bg-[#F59E0B]/5 border border-[#F59E0B]/20 p-8 rounded-[2.5rem] backdrop-blur-md">
                <h3 className="font-bold text-[#F59E0B] mb-6 flex items-center gap-3 uppercase tracking-widest text-[10px]">
      ...
      {/* Trust & Modern Vision */}
      <section className="py-32 px-6 text-center border-t border-white/5 relative z-10">
